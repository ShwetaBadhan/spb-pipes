...
//                                             <img src="{{url ('assets/img/theme/default.svg')}}" alt="img">
//                                         </span>                                     
...
//                                         <span class="d-block mb-2 layout-img">
//                                         <span class="theme-check rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                             <img src="{{url ('assets/img/theme/single.svg')}}" alt="img">
//                                         </span>                                    
...
//                                         <span class="d-block mb-2 layout-img">
//                                         <span class="theme-check rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                             <img src="{{url ('assets/img/theme/mini.svg')}}" alt="img">
//                                         </span>                                    
...
//                                         <span class="d-block mb-2 layout-img">
//                                         <span class="theme-check rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                             <img src="{{url ('assets/img/theme/transparent.svg')}}" alt="img">
//                                         </span>                                    
...
//                                         <span class="d-block mb-2 layout-img">
//                                         <span class="theme-check rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                             <img src="{{url ('assets/img/theme/without-header.svg')}}" alt="img">
//                                         </span>                                    
...
//                                     <span class="d-block mb-2 layout-img">
//                                         <img src="{{url ('assets/img/theme/rtl.svg')}}" alt="img">
//                                     </span>                                    
...
//                                     <img src="{{url ('assets/img/theme/sidebar-bg-01.svg')}}" alt="img" class="rounded">
//                                 </label>
//                             </div>
//                             <div class="theme-sidebarbg me-3 mb-3">
...
//                                  <span class="theme-check2 rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                     <img src="{{url ('assets/img/theme/sidebar-bg-02.svg')}}" alt="img" class="rounded">
//                                 </label>
//                             </div>
//                             <div class="theme-sidebarbg me-3 mb-3">
...
//                                  <span class="theme-check2 rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                     <img src="{{url ('assets/img/theme/sidebar-bg-03.svg')}}" alt="img" class="rounded">
//                                 </label>
//                             </div>
//                             <div class="theme-sidebarbg me-3 mb-3">
...
//                                  <span class="theme-check2 rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                     <img src="{{url ('assets/img/theme/sidebar-bg-04.svg')}}" alt="img" class="rounded">
//                                 </label>
//                             </div>
//                             <div class="theme-sidebarbg me-3 mb-3">
...
//                                  <span class="theme-check2 rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                     <img src="{{url ('assets/img/theme/sidebar-bg-05.svg')}}" alt="img" class="rounded">
//                                 </label>
//                             </div>
...
//                                  <span class="theme-check2 rounded-circle"><i class="fa-solid fa-check"></i></span>
//                                     <img src="{{url ('assets/img/theme/sidebar-bg-06.svg')}}" alt="img" class="rounded">
//                                 </label>
//                             </div>
//                         </div>
//                       </div>
