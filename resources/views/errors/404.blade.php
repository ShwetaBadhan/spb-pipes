    ...
    background: #f1f1f1;
        ...
        */
        ...
        form .search-btn {
            ...
            width: 15%;
            padding: 10px;
            background-image: linear-gradient(120deg, #012d80 0%, #045bb8 60%, #012d80 100%) !important;
            color: white;
            font-size: 17px;
            border: 1px #012d80 solid;
            border-left: none;
            /* Prevent double borders */
            border: 1px #045bb8 solid;
    ...
    <div class="container error-container">
        <div class="row  d-flex align-items-center justify-content-center">
            ...
            <div class="col-md-6  text-center">
                ...
                <a href="{{ route('home') }}" class="button button-dark-blue iq-mt-15 text-center">GOTO HOME PAGE</a>
