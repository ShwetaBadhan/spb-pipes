...
<meta http-equiv="Cache-Control" content="no-transform">
	...
	<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon" href="{{ tenant_storage_url($system_favicon) ?? asset('assets/img/favicon.png') }}">

<!-- Apple Touch Icon -->
<link rel="apple-touch-icon" sizes="180x180" href="{{ tenant_storage_url($system_favicon) ?? asset('assets/img/favicon.png') }}">
