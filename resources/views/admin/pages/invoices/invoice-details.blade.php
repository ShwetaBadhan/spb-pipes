					...
					<div class="col-md-10 mx-auto">
						<div>
							<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
								<h6><a href="{{route('invoices-view')}}"><i class="isax isax-arrow-left me-2"></i>Invoice (Admin)</a></h6>
										...
										<div class="d-flex align-items-center justify-content-between border-bottom flex-wrap mb-3 pb-2 position-relative z-1">
											<div class="mb-3">
												...
												<div class="d-flex align-items-center flex-wrap row-gap-3">
													...
													<span><img src="{{ url ('assets/img/icons/not-paid.png')}}" alt="img" width="48" height="48"></span>
												</div>
											</div>
											<div class="mb-3">
											...
											<div class="col-lg-4">
												<div>
													...
													<div>
														...
														<p class="mb-1">Email : <a href="https://kanakku.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="355c5b535a75504d54584559501b565a58">[email&#160;protected]</a></p>
												...
												<div>
													...
													<div class="bg-white rounded p-3">
														<div class="d-flex align-items-center mb-1">
															<img src="{{ url ('assets/img/icons/billing-to-image.svg')}}" alt="img" class="avatar avatar-lg me-2">
															<div>
														...
														<p class="mb-1">Phone : +1 54664 75945</p>
														<p class="mb-1">Email : <a href="https://kanakku.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0e676068614e6b766f637e626b206d6163">[email&#160;protected]</a></p>
														<p class="mb-0">GST : 243E45767889</p>
													</div>
												</div>
											</div><!-- end col -->
											...
											<div class="col-lg-6">
												<div class="d-flex align-items-center p-4 mb-3">
													<div class="me-3">
														...
														<span><img src="{{ url ('assets/img/icons/qr.png')}}" alt="QR"></span>
													</div>
													<div>
									...
									<div class="row">
										...
										<div class="col-lg-5">
											<div class="text-lg-end mb-3">
												<span><img src="{{ url ('assets/img/icons/sign.png')}}" class="sign-dark" alt="img"></span>
