                    ...
                    <div class="col-md-11 mx-auto">
                        <div>
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h6><a href="{{ route('invoices-view') }}"><i class="isax isax-arrow-left me-2"></i>Invoice</a></h6>
                                <a href="{{ route('invoice-details') }}" class="btn btn-outline-white d-inline-flex align-items-center"><i class="isax isax-eye me-1"></i>Preview</a>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="border border-dashed bg-light rounded text-center p-3 mb-3">
                                                                <img src="{{ url('assets/img/invoice-logo.svg')}}" class="invoice-logo-dark" alt="img">
									                            <img src="{{ url('assets/img/invoice-logo-white-2.svg')}}" class="invoice-logo-white" alt="img">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="row gx-3">
                                                    ...
                                                    <div class="card shadow-none">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="bg-light border rounded p-3 d-flex align-items-start">
                                                                <span class="avatar avatar-lg border flex-shrink-0 me-3"><img src="{{ url('assets/img/logo-small.svg')}}" alt="User Img"></span>
                                                                <div>
                                                                    ...
                                                                    <p class="mb-1 fs-13">Email : <a href="https://kanakku.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7910171f16391c01181409151c571a1614">[email&#160;protected]</a></p>
                                                    ...
                                                    <div class="card shadow-none">
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="bg-light border rounded p-3 d-flex align-items-start">
                                                                    <span class="avatar avatar-lg border bg-dark flex-shrink-0 me-3"><img src="{{ url('assets/img/icons/black-icon.png')}}" alt="User Img"></span>
                                                                    <div>
                                                                        <h6 class="fs-14 fw-semibold mb-1">Timesquare Tech</h6>
                                                                        <p class="mb-1 fs-13">299 Star Trek Drive, Florida, 32405, USA</p>
                                                                        <p class="mb-1 fs-13">Phone : +1 54664 75945</p>
                                                                        <p class="mb-1 fs-13">Email : <a href="https://kanakku.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bfd6d1d9d0ffdac7ded2cfd3da91dcd0d2">[email&#160;protected]</a></p>
                                                                        <p class="text-dark fs-13">GST : 243E45767889</p>
                                                                    </div>
                                                                </div>
                                                            </div>
