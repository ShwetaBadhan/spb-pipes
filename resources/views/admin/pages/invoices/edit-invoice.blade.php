                ...
                <div class="col-md-11 mx-auto">
                    <div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6><a href="{{ route('admin.invoices.index') }}"><i class="isax isax-arrow-left me-2"></i>Back to
                                    Invoices</a></h6>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="status" class="select">
                                                                <option value="draft"
                                                                    ...
                                                                    Draft</option>
                                                                <option value="sent"
                                                                    {{ $invoice->status == 'sent' ? 'selected' : '' }}>Sent
                                                                </option>
                                                                <option value="paid"
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" id="tax_type" name="tax_type">
                                                                <option value="none"
                                                                    {{ $invoice->tax_type == 'none' ? 'selected' : '' }}>No
                                                                    Tax</option>
                                                                <option value="gst_5"
                                                                    {{ $invoice->tax_type == 'gst_5' ? 'selected' : '' }}>
                                                                    GST 5%</option>
                                                                <option value="gst_12"
                                                                    {{ $invoice->tax_type == 'gst_12' ? 'selected' : '' }}>
                                                                    GST 12%</option>
                                                                <option value="gst_18"
                                                                    {{ $invoice->tax_type == 'gst_18' ? 'selected' : '' }}>
                                                                    GST 18%</option>
                                                                <option value="gst_28"
                                                                    {{ $invoice->tax_type == 'gst_28' ? 'selected' : '' }}>
                                                                    GST 28%</option>
                                                                <option value="cgst_sgst"
                                                                    {{ $invoice->tax_type == 'cgst_sgst' ? 'selected' : '' }}>
                                                                    CGST 9% + SGST 9%</option>
                                                                <option value="igst"
                                                                    {{ $invoice->tax_type == 'igst' ? 'selected' : '' }}>
                                                                    IGST 18%</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <tbody class="add-tbody" id="invoice-items">
                                                            ...
                                                            @foreach ($invoice->items as $item)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number"
                                                                            name="items[{{ $itemCount }}][discount_percent]"
                                                                            class="form-control discount-input"
                                                                            value="{{ $item->discount_percent ?? 0 }}"
                                                                            min="0" max="100">
                                                                    </td>
                                                                    <td>
                                                                        <!-- ✅ FIXED: Remove commas from amount input -->
                                                                        <input type="text"
                                                ...
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <h6 class="fs-14 fw-semibold">
                                                            <span
                                                                id="subtotal-amount">{{ number_format($invoice->subtotal, 2) }}</span>
                                                        </h6>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <h6 class="fs-14 fw-semibold">
                                                            <span
                                                                id="total-tax-amount">{{ number_format($invoice->total_tax, 2) }}</span>
                                                        </h6>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <input type="number" name="shipping_cost" class="form-control"
                                                            value="{{ $invoice->shipping_cost ?? 0 }}" step="0.01"
                                                            min="0" style="width: 120px;" id="shipping-input">
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="form-check form-switch me-4">
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                value="1" {{ $invoice->round_off ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="round_off">Round Off
                                                                Total</label>
                                                        </div>
                                                        <h6 class="fs-14 fw-semibold">
                                                            <span
                                                                id="grand-total">{{ number_format($invoice->grand_total - ($invoice->round_off_amount ?? 0), 2) }}</span>
                                                        </h6>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <h6><span
                                                                id="final-total">{{ number_format($invoice->grand_total, 2) }}</span>
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateTotals() {
                ...
                taxBreakdown.innerHTML = ''; // Clear existing tax rows
                ...
                // ✅ FIX: Get discount based on selected type
                let discount = 0;
            ...
            // ✅ CRITICAL FIX: Initialize discount type based on saved invoice data
            @php
                $hasPercentDiscount = ($invoice->discount_percent ?? 0) > 0;
                $hasAmountDiscount = ($invoice->discount_amount ?? 0) > 0;
            @endphp

            // Check if invoice has percentage discount saved
            @if ($hasPercentDiscount)
                document.getElementById('discount_percent').checked = true;
                document.getElementById('discount-percent-section').style.display = 'block';
                document.getElementById('discount-amount-section').style.display = 'none';
                document.getElementById('discount-percent-input').value = {{ $invoice->discount_percent }};
            @elseif ($hasAmountDiscount)
                document.getElementById('discount_amount').checked = true;
                document.getElementById('discount-percent-section').style.display = 'none';
                document.getElementById('discount-amount-section').style.display = 'block';
                document.getElementById('discount-amount-input').value = {{ $invoice->discount_amount }};
            @else
        ...
        <tr>
            ...
            // ✅ Initialize calculations AFTER setting up discount visibility
            calculateTotals();
        });
    </script>
@endpush
