                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                        <div class="avatar-list-stacked me-1">
                            <span class="avatar avatar-rounded avatar-sm">
								<img src="{{ url('assets/img/profiles/avatar-05.jpg') }}" alt="img">
							</span>
                            <span class="avatar avatar-rounded avatar-sm">
								<img src="{{ url('assets/img/profiles/avatar-12.jpg')}}" alt="img">
							</span>
                            <span class="avatar avatar-rounded avatar-sm">
								<img src="{{ url('assets/img/profiles/avatar-06.jpg')}}" alt="img">
							</span>
                            <span class="avatar avatar-rounded avatar-sm">
								<img src="{{ url('assets/img/profiles/avatar-18.jpg')}}" alt="img">
							</span>
                            <span class="avatar avatar-rounded avatar-sm">
								<img src="{{ url('assets/img/profiles/avatar-16.jpg')}}" alt="img">
							</span>
                        </div>
                        <div class="dropdown">
                        ...
                        <div>
                            <a href="{{ route('add-invoice') }}" class="btn btn-primary d-flex align-items-center">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                    <img src="{{ url('assets/img/profiles/avatar-28.jpg') }}" class="rounded-circle" alt="img">
                                                </a>
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Emily Clark</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>22 Feb 2025</td>
                            ...
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('invoice-details') }}" class="link-default">INV00020</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">David Anderson</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>09 Dec 2024</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Charlotte Brown</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>05 Oct 2024</td>
                            ...
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('invoice-details') }}" class="link-default">INV00021</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Olivia Harris</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>04 Jan 2025</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Daniel Martinez</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>12 Oct 2024</td>
                            ...
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Sophia White</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>30 Jan 2025</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('invoice-details') }}" class="link-default">INV00018</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Robert Thomas</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>15 Nov 2024</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Mia Thompson</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>02 Sep 2024</td>
                            ...
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Michael Johnson</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>17 Jan 2025</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('invoice-details') }}" class="link-default">INV00017</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Isabella Scott</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>30 Nov 2024</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('invoice-details') }}" class="link-default">INV00012</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Amelia Robinson</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>07 Aug 2024</td>
                            ...
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">John Carter</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>07 Feb 2025</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('invoice-details') }}" class="link-default">INV00019</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">Emma Lewis</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>02 Dec 2024</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 fw-medium mb-0"><a href="">William Parker</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>05 Oct 2024</td>
                                ...
                                <ul class="mb-3">
                                    ...
                                    <li>
                                        <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                            <input class="form-check-input m-0 me-2" type="checkbox">
                                            <span class="avatar avatar-sm rounded-circle me-2"><img src="{{ url('assets/img/profiles/avatar-28.jpg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>Emily Clark
                                        </label>
                                    </li>
                                    <li>
                                        <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                            <input class="form-check-input m-0 me-2" type="checkbox">
                                            <span class="avatar avatar-sm rounded-circle me-2"><img src="{{ url('assets/img/profiles/avatar-28.jpg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>John Carter
                                        </label>
                                    </li>
                                    <li>
                                        <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                            <input class="form-check-input m-0 me-2" type="checkbox">
                                            <span class="avatar avatar-sm rounded-circle me-2"><img src="{{ url('assets/img/profiles/avatar-28.jpg') }}" class="flex-shrink-0 rounded-circle" alt="img"></span>Sophia White
                                        </label>
                                    </li>
                                    <li>
                                        <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="invoices.html" class="btn btn-primary">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
