...
@endif
                ...
                Hi, {{ auth()->user()->name }}
								...
								<div class="d-flex align-items-center flex-wrap gap-3">
									<p class="d-flex align-items-center fs-13 text-white mb-0"><i class="isax isax-calendar5 me-1"></i>{{ now()->format('l, d M Y') }}</p>
									<p class="d-flex align-items-center fs-13 text-white mb-0"><i class="isax isax-clock5 me-1"></i> <span id="current-time"></span></p>
								</div>
							</div>
						</div><!-- end col -->
					</div>
					...
					<div class="col-xl-6 d-flex">
						<div class="card flex-fill">
							<div class="card-body">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															<h6 class="fs-14 fw-medium mb-1"><a href="">Emily Clark</a></h6>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															<h6 class="fs-14 fw-medium mb-1"><a href="">John Smith</a></h6>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															<h6 class="fs-14 fw-medium mb-1"><a href="">Olivia Harris</a></h6>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															<h6 class="fs-14 fw-medium mb-1"><a href="">William Parker</a></h6>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															<h6 class="fs-14 fw-medium mb-1"><a href="">Charlotte Brown</a></h6>
								...
								<a href="" class="btn btn-light btn-lg w-100 text-decoration-underline mt-3">All Customers</a>
							</div> <!-- end card body -->
						</div> <!-- end card -->
					</div> <!-- end col -->
				</div>
							...
							<div class="card-body">
								...
								<div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
									<div class="d-flex align-items-center">
										...
										<div>
											<h6 class="fs-14 fw-semibold mb-1"><a href="">Emily Clark</a></h6>
								...
								<div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
									<div class="d-flex align-items-center">
										...
										<div>
											<h6 class="fs-14 fw-semibold mb-1"><a href="">David Anderson</a></h6>
								...
								<div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
									<div class="d-flex align-items-center">
										...
										<div>
											<h6 class="fs-14 fw-semibold mb-1"><a href="">Sophia White</a></h6>
								...
								<div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
									<div class="d-flex align-items-center">
										...
										<div>
											<h6 class="fs-14 fw-semibold mb-1"><a href="">Michael Johnson</a></h6>
