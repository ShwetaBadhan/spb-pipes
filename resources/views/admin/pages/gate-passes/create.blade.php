                ...
                <div class="card">
                    ...
                    <form action="{{ route('admin.gate-passes.store') }}" method="POST">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="invoice_id" id="invoice-select" class="form-select" disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="batch_number" id="batch_number" 
                                               ...
                                               value="{{ old('batch_number') }}" placeholder="e.g., VH-101" required>
                                        @error('batch_number')
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('admin.gate-passes.index') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
