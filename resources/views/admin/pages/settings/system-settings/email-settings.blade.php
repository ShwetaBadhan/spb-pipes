                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                                                            ...
                                                            <span class="badge badge-soft-primary d-flex align-items-center">
                                                                <span class="badge-dot bg-dark me-1"></span> Not Connected
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="card-footer bg-light">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <a href="javascript:void(0);" class="btn btn-sm btn-dark rounded-2 d-inline-flex align-items-center justify-content-center p-1 me-2" data-bs-toggle="modal" data-bs-target="#sendgrid">
                                                                    <i class="isax isax-setting-2 fs-14"></i>
                                                                </a>
                                                            </div>
                                                            <div class="form-check form-switch">
