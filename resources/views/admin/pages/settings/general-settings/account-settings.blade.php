  ...
  <!-- ========================
        ...
        <div class="page-wrapper">
            ...
            @endif
                                    ...
                                    <form action="{{ route('account-settings.update') }}" method="POST" enctype="multipart/form-data" id="accountSettingsForm">
                                        @csrf
                                        @method('PUT')
...
@endif
                                                ...
                                                <div class="d-inline-flex flex-column align-items-start">
                                                    <div class="drag-upload-btn btn btn-sm btn-primary position-relative mb-2">
                                                        ...
                                                        <input type="file" name="profile_image" class="form-control image-sign position-absolute top-0 start-0 w-100 h-100 opacity-0 cursor-pointer" accept="image/png, image/jpeg, image/jpg" onchange="previewImage(this)">
                                                    </div>
                                            ...
                                            <div class="row gx-3">
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                                               value="{{ old('name', $accountSetting?->name ?? Auth::user()?->name) }}" required>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                                               value="{{ old('email', $accountSetting?->email ?? Auth::user()?->email) }}" required>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" 
                                                               value="{{ old('mobile_number', $accountSetting?->mobile_number) }}" placeholder="e.g., +91 9876543210">
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="gender" class="select @error('gender') is-invalid @enderror">
                                                            <option value="">Select</option>
                                                            <option value="male" {{ old('gender', $accountSetting?->gender) == 'male' ? 'selected' : '' }}>Male</option>
                                                            <option value="female" {{ old('gender', $accountSetting?->gender) == 'female' ? 'selected' : '' }}>Female</option>
                                                            <option value="other" {{ old('gender', $accountSetting?->gender) == 'other' ? 'selected' : '' }}>Other</option>
                                                        </select>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group position-relative mb-3">
                                                            <input type="date" name="dob" class="form-control rounded-end @error('dob') is-invalid @enderror" 
                                            ...
                                            <div class="row gx-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="state_id" class="select @error('state_id') is-invalid @enderror" id="stateSelect" data-cities-url="{{ route('account-settings.cities', ['stateId' => ':id']) }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="city_id" class="select @error('city_id') is-invalid @enderror" id="citySelect">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="postal_code" class="form-control @error('postal_code') is-invalid @enderror" 
                                                               value="{{ old('postal_code', $accountSetting?->postal_code) }}" placeholder="e.g., 144001">
...
<style>
    ...
    .trash-top:hover { background: #c82333; }
</style>
@endpush
