                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-divide mb-0">
                                <li class="breadcrumb-item d-flex align-items-center"><a
                                        href="{{ route('dashboard') }}"><i class="isax isax-home-2 me-1"></i>Home</a>
                                </li>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div
                                                            class="notification-action d-flex align-items-center gap-2">
                                                            <a href="{{ $item['url'] }}"
                        ...
                        <div class="dropdown profile-dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
                                ...
                                <span class="avatar online">
                                    @php
                                        $profileImage = $accountSetting?->profile_image
                                            ? asset('storage/' . $accountSetting->profile_image)
                                            : asset('assets/img/profiles/avatar-01.jpg');
                                    @endphp
                                    <img src="{{ $profileImage }}" alt="{{ auth()->user()->name }}" alt="Img"
